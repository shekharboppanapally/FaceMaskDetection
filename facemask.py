...
st.write('This is a face mask detection web app made by shekhar_boppanapally')
st.write('It is made by using Support Vector Machine(SVM) Algorithm.SVM is one of the most popular supervised learning algorithms,which is used for classification as well as regression problems in Machine Learning')
